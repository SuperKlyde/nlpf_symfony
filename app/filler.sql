...
VALUES ('projet 1', 'description 1', 140, '2015-03-03' ,1),
  ('projet 2', 'description 2', 374, '2015-03-03' , 1),
  ('super projet', 'un projet vraiment super', 4450,'2015-03-03' , 3),
  ('EPITA Project', 'what else?', 246,'2015-03-03' , 2),
  ('projet raté', 'too bad...', 12, '2015-03-03' , 4),
  ('projet normale', 'un projet normal', 500, '2015-03-03' , 4);
